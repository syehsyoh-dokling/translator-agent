...
function App() {
  ...
  const [mode, setMode] = useState<'translate_only' | 'translate_and_answer'>('translate_and_answer');
    ...
    >
      <div style={{ maxWidth: 800, margin: '0 auto' }}>
        ...
        <p style={{ marginBottom: '1.5rem', color: '#9ca3af' }}>
          • Form teks → kirim ke <code>/api/v1/chat</code> <br />
          • Rekam suara → kirim ke <code>/api/v1/transcribe</code>, hasilnya otomatis mengisi teks sumber.
        </p>
          ...
          <div style={{ display: 'flex', flexWrap: 'wrap', gap: '0.75rem', alignItems: 'center' }}>
            ...
            {!isTranscribing && !isRecording && (
              <span style={{ fontSize: '0.85rem', color: '#9ca3af' }}>
                Tekan <strong>Start Mic</strong>, bicara, lalu tekan <strong>Stop Mic</strong>. Hasil akan masuk ke teks sumber.
              </span>
            )}
          </div>
        </div>
        ...
        <form onSubmit={handleSubmit} style={{ display: 'grid', gap: '1rem' }}>
          <div>
            ...
            <textarea
              ...
              placeholder="Tulis kalimat di sini, atau gunakan mic lalu hasilnya muncul di sini..."
            />
          </div>
